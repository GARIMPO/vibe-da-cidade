...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Banner images are publicly accessible') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Super admin can upload banner images') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Super admin can update banner images') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'Super admin can delete banner images') THEN
