...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Define TypeScript interfaces for our classes
    ...
    const handleMouseDown = (e) => {
      ...
      if (posX < 0 || posX > canvas.width || posY < 0 || posY > canvas.height) return;
    ...
    // Inicializar o WebGL já foi feito na linha 85, não precisamos repetir
    updateKeywords();
    initFramebuffers();
